#  — Сервис планирования питания и покупок 🍽️
...
**АуЕда** — это масштабируемая SaaS-платформа для планирования рациона, которая позволяет пользователям составлять меню, автоматически генерировать списки покупок и обмениваться рецептами внутри сообщества.
